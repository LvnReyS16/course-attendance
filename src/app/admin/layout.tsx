...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Sidebar */}
      <aside className="w-72 bg-white/80 backdrop-blur-xl border-r border-slate-200/60 shadow-xl">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50">
        {/* Top Header */}
        <header className="h-20 bg-white backdrop-blur-xl border-b border-slate-200/50 shadow-sm">
        ...
        {/* Content Container */}
        <div className="w-full bg-white/70 backdrop-blur-md shadow-md p-8 h-full">
          {children}
        </div>
      </main>
    </div>
